...
wMarker.other = {}
local main = CreateFrame("Frame", "wMarkerMain", UIParent, BackdropTemplateMixin and "BackdropTemplate")
...
local function createMover(width,height,parent,pt,relPt)
	local f = CreateFrame("Frame",nil,parent.main, BackdropTemplateMixin and "BackdropTemplate")
...
wMarker.options = CreateFrame("Frame", "wMarkerOptions", UIParent, BackdropTemplateMixin and "BackdropTemplate")
wMarker.options.name = "wMarker"
InterfaceOptions_AddCategory(wMarker.options)

wMarker.iconFrame = CreateFrame("Frame", "wMarker_iconFrame", wMarker.main, BackdropTemplateMixin and "BackdropTemplate")
...
local function iconNew(name, num)
	...
	local f = CreateFrame("Button", string.format("wMarker%sicon",name), wMarker.iconFrame, BackdropTemplateMixin and "BackdropTemplate")
...
local controlFrame = CreateFrame("Frame", "wMarker_controlFrame", wMarker.main, BackdropTemplateMixin and "BackdropTemplate")
...
local clearIcon = CreateFrame("Button", "wMarkerClearIcon", controlFrame, BackdropTemplateMixin and "BackdropTemplate")
...
local readyCheck = CreateFrame("Button", "wMarkerReadyCheck", controlFrame, BackdropTemplateMixin and "BackdropTemplate")
...
wFlares = {}
wFmain = CreateFrame("Frame", "wFlaresMain", UIParent, BackdropTemplateMixin and "BackdropTemplate")
