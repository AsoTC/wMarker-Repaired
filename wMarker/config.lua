...
-- Raid marker frame
wMarker.raidMark = CreateFrame("Frame", "wMarkerRaidMarker", options, BackdropTemplateMixin and "BackdropTemplate")
...
local raidAlpha = CreateFrame("Slider","raidAlpha",raid,"OptionsSliderTemplate", BackdropTemplateMixin and "BackdropTemplate")
...
-- World marker frame
wMarker.worldMark = CreateFrame("Frame", "wMarkerWorldMarks", options, BackdropTemplateMixin and "BackdropTemplate")
...
local update = CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate");
local event = CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate");
